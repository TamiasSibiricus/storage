<?php
  $output = "function selectURL(url) {
      ...
      url = '".Router::url('/'.Configure::read('Service.mediaPath', 'uploads').'/', true)."' + url;
...
<div class="localmedia index">
    ...
    <div class="actions">
        <ul>
            <li><?php echo $this->Html->link(__('Switch to S3 storage', true), array( 'controller' => 's3media', 'action'=>'browse')); ?></li>
