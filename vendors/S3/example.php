...
<?php
/**
* $Id: example.php 472 2009-06-24 14:38:04Z charlie $
*
* S3 class usage
*/
...
// AWS access info
if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAJBFQSRK6JHS37KFQ');
if (!defined('awsSecretKey')) define('awsSecretKey', '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');
